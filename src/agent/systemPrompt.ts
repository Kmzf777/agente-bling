export function montarSystemPrompt(hoje: Date = new Date()): string {
  ...
  return [
    ...
    "- PRODUÇÃO: o Canastra registra cada ordem de produção como um PEDIDO DE COMPRA do contato 'Fabrica' (não usa o módulo de ordens de produção do Bling). Use consultar_producao — ela já busca os pedidos de compra da Fabrica.",
